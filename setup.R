...
X <- renewSlot(X,
               "abstract_args_ls",
               {
                 ...
                 args_ls$abstract_ls <- list(Summary = "Most health economic analyses are undertaken with the aid of computers. However, the ethical dimensions of implementing health economic models as software are poorly understood. 
                                                        We propose that developers and funders of computational health economic models (CHEMs) share ethical responsibilities to (i) establish socially acceptable system requirements and design specifications; (ii) ensure fit for purpose implementation; and (iii) support socially beneficial use. 
                                                        ...
                                                        We propose six TRU criteria for assessing CHEMs: (T1) software files are open access; (T2) project team judgments and contributions are easily identified; 
