...
X <- renewSlot(X,
               "abstract_args_ls",
               {
                 ...
                 args_ls$abstract_ls <- list(Summary = "Most health economic analyses are undertaken with the aid of computers. However, the ethical dimensions of implementing health economic models as software are poorly understood. 
                                                        We propose that the core ethical responsibilities of model developers and funders over a health economic software development lifecycle are to (i) make socially acceptable system requirements and design decisions; (ii) ensure fit for purpose implementation; and (iii) support socially beneficial use. 
                                                        We further propose that a transparent (T), reusable (R) and updatable (U) computational health economic model (CHEM) is suggestive of a project team that has largely fulfilled these responsibilities.
