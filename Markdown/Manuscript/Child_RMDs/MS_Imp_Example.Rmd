...
We applied the framework to develop ready4 modules for developing utility mapping models, supplying those modules with data and implementing utility mapping analyses. These tools were created to develop utility mapping models for a clinical mental health sample of young people in a study that has been previously described [@Hamilton2021.07.07.21260129]. The framework's modelling toolkit created the following ready artefacts:
