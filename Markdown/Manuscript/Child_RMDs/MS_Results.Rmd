...
```{r tab.cap='TIMELY Checklist with utility mapping study worked example', tab.id = 'checklisttb', echo = F, results = 'asis'}
    #  a <- c("TEST1","TEST2")
...
checklist_df <- data.frame(Standard = c(paste0("T",1:6, c(" (Publicly archived)",
                                                          " (Documented)",
                                                          " (Simple Syntax)",
                                                          " (Literate programming)",
                                                          " (Code coverage)",
                                                          " (Reproducibility")),
                                        paste0("I",1:4, c(" (Version controlled)",
                                                          " (Semantic versioning)",
                                                          " (Continuous integration)",
                                                          " (Deprecation)")),
                                        paste0("M",1:2, c(" (Decouple code and data)",
                                                          " (Encapsulation)")),
                                        paste0("E",1:3, c(" (Code libraries)",
                                                          " (Inheritance)",
                                                          " (Test data)")),
                                        paste0("L",1:3, c(" (Copyleft for code)",
                                                          " (Liberal, safe data terms)",
                                                          " (Citation tools)")),
                                        paste0("Y",1:2, c(" (Statistical model tools)",
                                                          " (User-interfaces"))),
                           Assessment = rep("Met so well it hurts",20),
                           Description = c("5 libraries [@hamilton_matthew_2022_6084467;@hamilton_matthew_2022_6084824;@hamilton_matthew_2022_6116701;@gao_caroline_2022_6130155;@matthew_p_hamilton_2021_5646669], 3 programs [@hamilton_matthew_2022_6129906;@hamilton_matthew_2022_6416330;@hamilton_matthew_p_2022_6321821], 2 sub-routines [@hamilton_matthew_2022_6116385;@matthew_p_hamilton_2022_5976988] and 2 datasets [@DVN/DKDIB0_2021;@DVN/HJXYKQ_2021]",
# @hamilton_matthew_2022_6084467;@hamilton_matthew_2022_6084824;@hamilton_matthew_2022_6116701;@gao_caroline_2022_6130155;@matthew_p_hamilton_2021_5646669
# Programs:
