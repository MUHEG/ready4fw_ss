...
### Software
We have written six R packages to support the development and curation of model code and data. The purpose of each package, the TIMELY standards they support and the existing R packages they depend on are summarised in Table 1.

```{r cpkgs, tab.cap='Software', tab.id = 'cpkgs', echo = F, results = 'asis'}
      tb <- tibble::tibble(Package = c("ready4","ready4fun"),
                                                    Version = Package %>%
...
# packages_df <- data.frame(Name = c("ready4", "ready4fun"),
#                           Purpose = c("Provide framework modules and syntax",
#                                       "Standardise and partially automate the authoring and documenting of functions."),
#                           `Supports standard` = c("AAAA","BBB"),
#                           Depends = c("A","B")) 
