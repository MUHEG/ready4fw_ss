...
Open source frameworks have been recommended to develop the mental health modelling field [@RN73] but, as with health economics more generally, OSHEMs remain rare. Currently there is only one mental health related model (in Alcohol Use Disorder [@Basu2018]) that is indexed in the Open Source Models Clearinghouse [@OSMC_20xx;@Emerson2019]. An open source Major Depressive Disorder reference model for the United States [@IVIMDD2022] is also in development <!-- as part of the Open Value Initiative [@Jansen2019].  -->Greater use of open source approaches could help improve the scope, validity and usefulness of mental health economic models.

Major mental health reform programs, <!-- such as those currently being implemented in Victoria, Australia [@VicRC2021],  -->can involve the identification, prioritisation, sequencing, targeting and monitoring of multiple interdependent initiatives. Single purpose models that assume static systems may be inadequate for the decision support needs of policymakers and service planners [@PC2020]. Mental health simulation studies rarely model complex dynamic systems [@RN73] with economic studies predominantly examining the affordability and value for money of individual mental health programs [@RN34]. Systems modelling approaches, that have been recommended for public health economics more generally [@SQUIRES2016588] and for mental health specifically [@Occhipinti2021], could provide greater insight about inter-dependencies between candidate policies and the dynamic nature of the mental health systems planning context. Dynamic systems methods might provide the foundations for developing reference models [@Afzali2013] of mental health systems that are intended for multiple-applications and re-use by different modelling teams. However, more complex models may be more prone to error [@Saltelli2019] and models designed for multiple purposes require greater investments in model transparency and validation [@Eddy2012; @Feenstra2022]. 
...
## Framework standards
Based on existing open science guidance and our own experience, we have identified 20 standards that are important for quality implementations of OSHEMs, each described under one of following six principles for making models **TIMELY**:
