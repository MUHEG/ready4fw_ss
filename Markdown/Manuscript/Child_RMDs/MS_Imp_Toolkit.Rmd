...
1) Provide a standardised template model module and programming syntax.

2) Develop consolidated project documentation and provide tools to find model modules, datasets and study replication programs.

3) Author, document and share model modules, integrating with online services for open source software development

4) Ingest, label and share model data, integrating with online services for open science data archiving.

5) Implement integrated and reproducible data ingest, analysis and reporting pipelines.
