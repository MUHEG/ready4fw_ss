...
---
```{r cpkgs, tab.cap='Framework software to enable the readyforwhatsnext model to meet TIMELY guidelines', tab.id = 'cpkgs', echo = F, results = 'asis'}
library(kableExtra)  
df <- tibble::tibble(Package = c("ready4",
  ...
  as.data.frame() 
    df$Ref <- c("@ready42022",
                    ...
                    "@ready4show2022")
df <- df %>%
  dplyr::mutate(Guideline = purrr::pmap_chr(df,
                                           ~paste0("T",
                                                  ..3,
                                                  paste0(rep("&nbsp;",
