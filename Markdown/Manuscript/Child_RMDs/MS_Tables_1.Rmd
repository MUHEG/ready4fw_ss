...
library(kableExtra)  
df <- data.frame(`Implications` = c(rep("Project resource requirements",4), rep("Ethical considerations",10)),
                 `Commercial modelling software` = c("(+) Will include tools to accomplish most common modelling tasks swiftly and reliably.",
                                                     "(+) Requires less extensive range of (potentially hard to find) programming skills.",
                                                     "(-) Requires model developers and users to purchase software licenses ",
                                                     "",
                                                     "Transparency",
                                                     "(+) Tools with mass market adoption (e.g. Excel) are readily understood by many.",
                                                     "(-) Lack of scientific manuscript authoring workflow tools may result in (undetected) transcription errors when reporting results.",
                                                     "",
                                                     "Reusability",
                 ...
                 `Open-source programming language` = c("(-) Initial development is likely to be time and resource intensive.",
                                                        "(+) Over medium to long term there is the potential for efficiency savings if:",
                                                        "(i)	model development can leverage artefacts (code and data) from pre-existing models; and / or",
                                                        "(ii)	project requirements include model maintenance and transfer.",
                                                        "Transparency",
                                                        "(+) Easy to publicly share testable source code while selectively restricting access to confidential data.",
                                                        "(+) Easy to make clear who developed and tested each part.",
                                                        "(-) Novel code increases likelihood of (undetected) software errors.",
                                                        "Reusability",
                                                        "(-) Potentially fragile – if not maintained or bundled with all required and correctly versioned dependencies",
