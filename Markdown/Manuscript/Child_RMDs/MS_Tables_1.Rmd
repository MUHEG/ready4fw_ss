...
---
```{r proscons, tab.cap='Considerations when choosing between implementing computational models using commercial modelling software or as software projects using an open-source programming language', tab.id = 'proscons', echo = F, results = 'asis'}
library(kableExtra)  
