...
Although we are principally interested in using readyforwhatsnext to answer policy questions relating to the mental health of young people in Australia, we want to facilitate transferability by other teams to different jurisdictions. A high level schematic of how we aim to implement readyforwhatsnext as a modular and open source CHEM is outlined in Figure \@ref(fig:fig1). 
