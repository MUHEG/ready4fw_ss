...
## Transferability
Although we are principally interested in using readyforwhatsnext to answer policy questions relating to the mental health of young people in Australia, we want to facilitate model transfer to other jurisdictions. We believe that a good starting point for facilitating model transferable is to develop a CHEM that is relatively easy to understand, use and adapt. For that reason, the transferability requirements we specified for readyforwhatsnext are to meet six explicit criteria for transparency, reusability and updatability. We have describe these criteria and theire relationship to ethical modelling practice elsewhere [@ethicsCHEMS2024], but briefly they are: 
...
T4) Licenses restrict permit derivative works; <!-- rephrase Liceses permit derivative works-->
